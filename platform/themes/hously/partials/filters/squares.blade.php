<div>
    ...
    <div class="relative mt-2 filter-search-form filter-border">
        ...
        <input name="min_square" value="{{ BaseHelper::stringify(request()->query('min_square')) }}" type="number" id="min-square" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" placeholder="{{ __('Square From') }}">
    </div>
</div>
...
<div>
    ...
    <div class="relative mt-2 filter-search-form filter-border">
        <i class="mdi mdi-currency-usd icons"></i>
        <input name="max_square" value="{{ BaseHelper::stringify(request()->query('max_square')) }}" type="number" id="max-square" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" placeholder="{{ __('Square To') }}">
    </div>
</div>
