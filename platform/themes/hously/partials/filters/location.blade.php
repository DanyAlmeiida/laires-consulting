<div>
    ...
    <div class="relative mt-2 filter-search-form filter-border">
        ...
        <input name="location" value="{{ BaseHelper::stringify(request()->query('location')) }}" type="text" id="location-{{ $type }}" class="border-0 form-input filter-input-box bg-gray-50 dark:bg-slate-800" placeholder="{{ __('City, state') }}" autocomplete="off" data-url="{{ route('public.ajax.cities') }}">
